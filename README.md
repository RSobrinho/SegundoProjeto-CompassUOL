...
Get events filtered within a date range
...
### Get Events Filtered Within a Date Range Route

- In this route, two dates can be passed by the query params:
- startDate: Will get events that happens after or during that dateTime
- endDate: Will get the events that happens before or during that dateTime
- Both startDate and endDate are optional, so for this filter you can pass one or both params in the query.
